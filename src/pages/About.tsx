...
//             <h2 className="text-red-600 text-5xl md:text-6xl font-semibold mb-3 pb-12   flex items-center justify-center align-center ">
//         Ashish Pandey
//       </h2>
//       {/* <div className="w-full  md:w-1/2 flex justify-center items-center"> */}
//       <img
//         src={aboutImage}
//         alt="Ashish Pandey"
//         className="max-h-60 md:max-h-80 rounded-full flex flex-end"
//       />
//    </div>
